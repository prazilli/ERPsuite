...
let UsersController = class UsersController {
    ...
    async createUser(companyId, body, user) {
        return this.usersService.createUser(BigInt(companyId), body, user);
    }
    async findAll(companyId, search, page, limit, user) {
        return this.usersService.findAll(BigInt(companyId), user, search, page ? parseInt(page, 10) : undefined, limit ? parseInt(limit, 10) : undefined);
    }
    async getRoles() {
        return this.usersService.getRoles();
    }
    async createCustomRole(body, user) {
